...
console.log(artists[0]); // first artist "Amedeo Modigliani"

console.log(artists[2].bio); // Diego Rivera bio


/* Task 2: There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh is currently Vincent Van Dough. Use an array method to fix this issue and console.log() to check your work. */

console.log(artists[8].name.replace('Dough', 'Gogh')); // Used the replace() method to make correction. 

// exampple 2
artists[8].name = 'Vincent Van Gogh'; // Used the dot notation to make correction in the key's value pair. 
...
an array with names of artists who were 
born in and died in 20th century (1900-2000)
 example born in 1901 and died in 1959 - included / born in 1889 and died in 1925 not included 
- should return ["Salvador Dali", "Frida Kahlo"]*/

// Be sure to ask TL for review
...
newArtist = {
  ...
  genre: "Web Design",
  nationality: "Unknown",
  bio: "Lorem Lorem lorem lorem loren. Lorem lorem lorem lorem lorem lorem lorem lorem. "
};

function addArtist(newArtist) {
  let iamTheArtist = {};
  iamTheArtist = newArtist;
  artists.push(iamTheArtist);
  console.log(iamTheArtist);
};
...
function lotsOfArt(artists){
  return artists.filter(i => i.paintings > 100);
}
